...
<head>
    ...
    <title>Seller Login - FreshBasket Seller Central</title>
...
<div style="width:100%; max-width:1050px; display:grid; grid-template-columns:1fr 1fr; gap:0; border-radius:24px; overflow:hidden; box-shadow:0 32px 80px rgba(0,0,0,0.5);">
    ...
    <!-- Left Panel: Brand -->
    <div style="background:linear-gradient(140deg,#16a34a 0%,#7c3aed 60%,#ec4899 100%); padding:56px 48px; display:flex; flex-direction:column; justify-content:space-between; position:relative; overflow:hidden;">
        ...
        <div style="position:relative;z-index:1;">
            <a href="{{ route('home') }}" style="display:inline-flex;align-items:center;gap:10px;text-decoration:none;margin-bottom:48px;">
                ...
                <span style="color:#fff;font-size:20px;font-weight:800;">FreshBasket</span>
            </a>
    ...
    <div style="background:#ffffff;padding:56px 48px;display:flex;flex-direction:column;justify-content:center;">
        <div style="margin-bottom:36px;">
            ...
            <p style="color:#6b7280;font-size:14px;margin:0;">Don't have a seller account? <a href="{{ route('seller.register') }}" style="color:#16a34a;font-weight:600;text-decoration:none;">Register here →</a></p>
        </div>
        ...
        <form method="POST" action="{{ route('seller.login.store') }}" style="display:flex;flex-direction:column;gap:20px;">
            ...
            <div>
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" required placeholder="seller@yourstore.com"
                    ...
                    onfocus="this.style.borderColor='#16a34a';this.style.boxShadow='0 0 0 4px rgba(79,70,229,0.1)'"
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;">
                <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:14px;color:#4b5563;">
                    <input type="checkbox" name="remember" style="accent-color:#16a34a;width:16px;height:16px;">
                    Remember me for 30 days
                </label>
                <a href="{{ route('password.request') }}" style="font-size:14px;color:#16a34a;font-weight:600;text-decoration:none;">Forgot password?</a>
            </div>

            <button type="submit"
                style="width:100%;background:linear-gradient(135deg,#16a34a,#7c3aed);color:#fff;font-size:15px;font-weight:700;padding:15px;border:none;border-radius:12px;cursor:pointer;font-family:inherit;transition:all 0.2s;letter-spacing:0.3px;margin-top:4px;"
            ...
            <div style="text-align:center;font-size:13px;color:#9ca3af;padding-top:8px;">
                <p style="margin:0;">Want to sell on FreshBasket?</p>
